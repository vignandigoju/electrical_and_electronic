...
<body>
    ...
    <nav style="background-color: #3333; color: black; text-align: center;">
        <ul style="list-style-type: none; padding: 0; margin: 0;">
            ...
            <li style="display: inline; margin-right: 20px;"><a href="mainlogin.php">Logout</a></li>
        </ul>
    </nav>
    ...
    $sql = "SELECT  l.name,l.empid,l.status,i.issue FROM login l INNER JOIN issue i ON l.username=i.user_id WHERE l.role='worker' AND i.status!='completed' OR l.assign_task=1";
