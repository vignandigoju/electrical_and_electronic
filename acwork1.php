...
<div class="container">
        ...
        $sql = "SELECT name, brand, price, installation, warranty, warrantyend FROM eqdetails WHERE name='ac'";
        ...
        $sql = "SELECT servicetype, servicecharge, type, date, endby, status FROM job WHERE type = 'invoice'";
        $result = mysqli_query($conn, $sql);
    ...
    <div class="details">
        <img src="acimage.png" alt="Equipment Image" width="250" height="150">
