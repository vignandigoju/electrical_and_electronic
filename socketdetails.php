...
<div class="container">
        ...
        $sql = "SELECT name, brand, price, installation, warranty, warrantyend, location FROM eqdetails WHERE eid=$eid";
    ...
    <br></br>
        <div>
            <a href="socketassignwork.php"><button class="next-button">Next</button></a>
        </div>
    </div>
    <div class="details">
        <img src="img/sockets.jpg" alt="Equipment Image" width="250" height="150">
