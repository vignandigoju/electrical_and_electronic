...
<body>
    ...
    <div class="task-list" style="text-align: center; margin: 20px;">
        ...
        if ($result->num_rows > 0) {
            $prevStatus = ''; // Store the previous status
            while ($row = $result->fetch_assoc()) {
                ...
                // Display a horizontal line only when status changes
                ...
                $prevStatus = $status; // Update the previous status
            }    
        }  
